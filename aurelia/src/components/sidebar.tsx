...
const ChevronUpSvg = <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M480-528 296-344l-56-56 240-240 240 240-56 56-184-184Z" /></svg>
...
export default function SideBar() {
    ...
    const handleSubMenu = (data: string, e: MouseEvent) => {
        ...
        if (data === "fileSubMenu") {
            setFileSubMenu(!showFileSubMenu());
        }
    }
        ...
        <nav id="sidebar" classList={{ sideClosed: !showSideBar() }}>
            <ul>
                <li class="sideHeader" classList={{ sideHeaderClosed: !showSideBar() }}>
                    ...
                    <span class="sideClose" on:click={handleShowSide}>{showSideBar() ? CloseSideSvg : OpenSideSvg}</span>
                </li>
                ...
                <li class="noBack" classList={{ active: showFileSubMenu() }}>
                    <span class="sideButton" on:click={(e) => handleSubMenu("fileSubMenu", e)}>
                        ...
                        <Switch>
                            ...
                            <Match when={!showFileSubMenu()}>{ChevronDownSvg}</Match>
                        </Switch>
                    </span>
